class BurnItDown extends Phaser.Scene {
  constructor(){
    super({key:"BurnItDown"})
  }
  ...
  preload(){
    this.load.image('mainOrb', "../assets/redParkOrb.png")
    this.load.image('orb','../assets/red.png');
    this.load.image('horizontal', '../assets/redline.png')
    this.load.image("paddle", "../assets/bigIdea.png")
    this.load.image('fma2', "../assets/linkinPark.jpg")
    this.load.audio('Burnitdown', '../assets/Burnitdown.mp3')
    this.burnItDown = new Music("../assets/Burnitdown.mp3")
    this.burnItDown.loadSong(this.burnItDown.filePath);
  }
  ...
  create(){
    ...
    this.music = this.game.sound.add('Burnitdown')
    ...
    setTimeout(()=>{
      circleArr = this.burnItDown.show()
    ...
    this.add.text(width/8, 6*height/7, 'A', { fontFamily: 'Arial', fontSize: 64, color: '#890014' });
    this.add.text(3*width/8, 6*height/7, 'S', { fontFamily: 'Arial', fontSize: 64, color: '#890014' });
    this.add.text(5*width/8, 6*height/7, 'D', { fontFamily: 'Arial', fontSize: 64, color: '#890014' });
    this.add.text(7*width/8, 6*height/7, 'F', { fontFamily: 'Arial', fontSize: 64, color: '#890014' });
